  ...
  return (
    <>
      ...
      <div className="contentSection animate-fadeIn">
        ...
        <div
          ...
          <div className="relative  max-w-7xl mx-auto text-center lg:text-left">
            ...
            <p className="text-lg leading-relaxed mb-6 animate-fadeInLeft">
              ...
              outlined below. As mentioned, only a few elements differ in
              solving diverse issues with vashikaran therapy, offering an
              understanding of{" "}
        ...
        <div
          className="relative bg-cover bg-center bg-no-repeat text-white py-12 lg:py-16 px-6 lg:px-8"
          style={{ backgroundImage: `url(${image1})` }}>
          ...
          <div className="relative z-10 max-w-7xl mx-auto lg:flex lg:space-x-8">
            <div className="flex-1 text-center lg:text-left bg-white/10 p-8 rounded-lg shadow-md animate-fadeInUp">
              ...
              <p className="text-lg leading-relaxed mb-4">
                Vashikaran is an ancient science rooted in Indian culture. With
                over 20 years of experience, we assist with issues ranging from
                relationships to business challenges.
              </p>
              <h2 className="text-2xl font-bold mt-8 mb-4">
                What is Vashikaran?
              </h2>
              <p className="text-lg leading-relaxed mb-6">
                Trusted for centuries, Vashikaran is known for its impact on
                personal and professional life challenges. Our specialist
                provides solutions for each unique issue, utilizing sacred herbs
                and yantras.
              </p>
              <span className="block text-lg mt-6">
                Contact:{" "}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="mb-6 text-white leading-relaxed text-lg">
              Astrology is a science of the stars, affecting various aspects of
              life...
            </p>
        ...
        <div className="bg-red-400 p-4 border-2 border-black m-2">
          <ul className="grid custom-md:grid-cols-3 gap-4">
            {PlacesNames.map((item) => (
              <li
                className="p-1 border-b-slate-500 border-2"
                key={item.pathName}>
